...
//!
//! SSH URLs are used so the harness inherits the developer's git auth chain
//! without an explicit token — the provisioning step is responsible for the
//! one-time push, the harness only ever clones (read).

/// Single leaf pack, no children. Smoke-tests basic clone + checkout.
pub const FIXTURE_LEAF: &str = "git@github.com:egoisth777/grex-test-leaf.git";

/// Meta-pack containing N flat sub-packs (no further nesting).
pub const FIXTURE_META_FLAT: &str = "git@github.com:egoisth777/grex-test-meta-flat.git";

/// Meta-pack with sub-meta-packs nested at least one level deep.
pub const FIXTURE_META_NESTED: &str = "git@github.com:egoisth777/grex-test-meta-nested.git";

/// Cycle-detection fixture, side A. Imports `FIXTURE_CYCLE_B`.
pub const FIXTURE_CYCLE_A: &str = "git@github.com:egoisth777/grex-test-cycle-a.git";

/// Cycle-detection fixture, side B. Imports `FIXTURE_CYCLE_A`.
pub const FIXTURE_CYCLE_B: &str = "git@github.com:egoisth777/grex-test-cycle-b.git";

/// Manifest with intentionally malformed YAML / invalid schema.
pub const FIXTURE_BROKEN: &str = "git@github.com:egoisth777/grex-test-broken-manifest.git";
