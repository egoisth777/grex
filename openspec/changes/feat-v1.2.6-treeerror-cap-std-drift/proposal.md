...
- **Stale `manifest.md` rewrite** (doc) — `.omne/cfg/manifest.md` body refresh:
...
11. **Changelog/history.** `CHANGELOG.md [1.2.6]` entry + `.omne/cfg/history.md` v1.2.6 entry (separate SSOT repo per Rule 7).
