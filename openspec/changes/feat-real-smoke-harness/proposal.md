...
- **SSOT documentation** at `.omne/cfg/real-smoke.md` (new file — G1 routing entry + INDEX update).
...
7. SSOT update lands in the **separate** `grex-inst` repo (Rule 7): `.omne/cfg/real-smoke.md` (new), `.omne/schemas/rules.md` G1 row added, `.omne/INDEX.yaml` regenerated by `scripts/build_index.py`.
