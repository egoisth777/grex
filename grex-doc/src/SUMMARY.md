...
- [CLI JSON output](./reference/cli-json.md)
...
- [Linter](./internals/linter.md)
- [Man pages](./internals/man-pages.md)
- [Roadmap](./internals/roadmap.md)
- [M3 review findings](./internals/m3-review-findings.md)
...
- [MCP conformance](./ci/mcp-conformance.md)
