...
* `inst/concurrency.md` §Lean4 invariant — primary spec
* `inst/architecture.md` §Runtime invariants — identifies I1
...
lock-acquisition order in `inst/concurrency.md` plus this Lean
